...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/marie/Desktop/Psychopy Test/Staircase_Test/Staircase_Test_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Stable_Triangle = visual.ShapeStim(
        win=win, name='Stable_Triangle',units='pix', 
        size=[25,25], vertices='triangle',
        ori=0.0, pos=[-20,0], draggable=True, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor=[1.0000, -1.0000, -1.0000], fillColor=[1.0000, -1.0000, -1.0000],
        opacity=None, depth=-2.0, interpolate=True)
    Change_Triangle = visual.ShapeStim(
        win=win, name='Change_Triangle',units='pix', 
        size=[1.0, 1.0], vertices='triangle',
        ori=0.0, pos=[20,0], draggable=False, anchor='center',
        lineWidth=1.0,
    ...
    for level, condition in trials:
        ...
        if map(lambda x: x>25, Change_Triangle.size):
            CorrectAns= 'left'
        else:
            CorrectAns= 'right'
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_allKeys):
                    ...
                    # was this correct?
                    if (key_resp.keys == str('(25,25)')) or (key_resp.keys == '(25,25)'):
                        key_resp.corr = 1
                    else:
                        key_resp.corr = 0
                    # a response ends the routine
